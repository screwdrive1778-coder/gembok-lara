        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="flex items-center mb-6">
                    <a href="{{ route('admin.ip-monitor.show', $ipMonitor) }}" class="text-gray-400 hover:text-white mr-4">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="text-2xl font-bold text-white">Edit IP Monitor</h1>
                        <p class="text-gray-400">{{ $ipMonitor->ip_address }}</p>
                    </div>
                </div>

                <!-- Form -->
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    <form action="{{ route('admin.ip-monitor.update', $ipMonitor) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="ip_address" value="{{ old('ip_address', $ipMonitor->ip_address) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name', $ipMonitor->name) }}"
                                       class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500"
                            ...
                            <div>
                                ...
                                <select name="customer_id" class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500">
                                    ...
                                    <option value="{{ $customer->id }}" {{ old('customer_id', $ipMonitor->customer_id) == $customer->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select name="network_device_id" class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500">
                                    ...
                                    <option value="{{ $device->id }}" {{ old('network_device_id', $ipMonitor->network_device_id) == $device->id ? 'selected' : '' }}>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="check_interval" value="{{ old('check_interval', $ipMonitor->check_interval) }}" required min="60" max="3600"
                                           class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="alert_threshold" value="{{ old('alert_threshold', $ipMonitor->alert_threshold) }}" required min="1" max="10"
                                           class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500">
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $ipMonitor->is_active) ? 'checked' : '' }}
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="alert_enabled" value="1" {{ old('alert_enabled', $ipMonitor->alert_enabled) ? 'checked' : '' }}
                                           class="w-4 h-4 text-cyan-600 bg-gray-700 border-gray-600 rounded focus:ring-cyan-500">
                        ...
                        <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-700">
                            <a href="{{ route('admin.ip-monitor.show', $ipMonitor) }}" class="px-6 py-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600 transition">
                                Batal
                            </a>
