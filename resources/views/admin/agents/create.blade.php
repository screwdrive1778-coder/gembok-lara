        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                <div class="flex items-center space-x-2 text-sm text-gray-600 mb-2">
                    ...
                    <a href="{{ route('admin.agents.index') }}" class="hover:text-blue-600">Agents</a>
                    <i class="fas fa-chevron-right text-xs"></i>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 max-w-3xl">
                <form action="{{ route('admin.agents.store') }}" method="POST">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-4">
                        <a href="{{ route('admin.agents.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
